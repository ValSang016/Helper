 ...
 */
 ...
 router.get('/', function(req, res, next) {
   res.render('board/board', { "title" : '게시판' });
 });
 
 router.get('/write', function (req, res, next) {
   res.render('crud/writeform', { "title" : "글쓰기" });
 });
 ...
 router.get('/read/:page/:num', function (req, res, next) {
   ...
   db_board.read(num, function (data) {
     ...
     res.render('crud/read', {"title" : "글 읽기", "data" : data, "page" : page});
   });
 });
 ...
 router.get('/update/:page/:num', function (req, res, next) {
   ...
   db_board.updateform(num, function (data) {
     res.render('crud/updateform', {"title" : "수정하기", "data" : data, "page" : page});
   });
 });
 ...
 router.post('/update', function (req, res, next) {
   ...
   db_board.update(datas, function (data) {
     //res.json({result : data});
     res.redirect('board/board/list/' + page);
